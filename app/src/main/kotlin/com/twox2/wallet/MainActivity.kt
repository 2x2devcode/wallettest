...
fun WalletApp(viewModel: WalletViewModel) {
    ...
    val tabs = listOf(
        TabItem("Painel", Icons.Default.AccountBalance),
        TabItem("Enviar", Icons.AutoMirrored.Filled.Send),
        TabItem("Receber", Icons.Default.QrCode),
        TabItem("Histórico", Icons.Default.History),
    ...
    Scaffold(
        ...
        Box(Modifier.padding(padding)) {
            when (selectedTab) {
                ...
                1 -> SendScreen(viewModel)
                2 -> ReceiveScreen(viewModel)
